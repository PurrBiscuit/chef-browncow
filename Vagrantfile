...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision :chef_client do |chef|
    chef.chef_server_url        = "https://api.opscode.com/organizations/browncow"
    chef.validation_client_name = "browncow-validator"
    chef.validation_key_path    = ".chef/browncow-validator.pem"
